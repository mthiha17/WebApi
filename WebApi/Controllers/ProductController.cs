...
using WebApi.Database.AppDbContextModels;
using WebApi.Models;
...
namespace WebApi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public IActionResult CreateProduct([FromBody] ProductCreateRequest request)
        {
            ...
            var product = new Database.AppDbContextModels.TblProduct
            {
                Name = request.Name,
                Price = request.Price,
        ...
        // Response: 200 OK or 404 Not Found
        [HttpPatch("{id}")]
        public IActionResult PatchProduct(int id, [FromBody] JsonPatchDocument<Database.AppDbContextModels.TblProduct> patchDoc)
        {
            ...
            patchDoc.ApplyTo(itemProduct, (Microsoft.AspNetCore.JsonPatch.Adapters.IObjectAdapter)ModelState);
